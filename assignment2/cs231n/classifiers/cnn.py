...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params = {
          ...
          'W2': np.random.randn(F* H*W// (2*2),  hidden_dim) * weight_scale, # due to 2*2 pooling
    ...
    def loss(self, X, y=None):
        ...
        # out,cache_fc1_relu2 = affine_relu_forward(out, W2, b2)
        ...
        # dout, dW2, db2 = affine_relu_backward(dout, cache_fc1_relu2)
        # dout, dW1, db1 = conv_relu_pool_backward(dout, cache_conv_relu_pool)

        # grads = {
        #   'W3': dW3, 'W2':dW2, 'W1':dW1, 'b3':db3, 'b2':db2, 'b1':db1
        # }

        # grads['W3']+=self.reg * W3 #self.params['W3']
        # grads['W2']+=self.reg * W2 #self.params['W2']
        # grads['W1']+=self.reg * W1 #self.params['W1']
